...
import BabyCareList from "./BabyCareList";
...
const BabyCare = () => {
    const {Baby_Care,See_All}=useTranslation()
    ...
    var config = {
        method: 'get',
        url: `http://52.202.149.74/pharmacy-online/shop/get_products.php?lang=${json.lang}&category=baby_care`,
        headers: { 
    ...
    return (
        <View  >
            <View style={styles.input_container}>
                ...
                <TouchableOpacity onPress={()=>navigation.navigate("ItemsList",{title:Baby_Care,title_en:"baby care"})}>
                <Text>
                    {See_All}
                </Text>
                </TouchableOpacity>
